...
namespace GraphAlgorithms.Repository.Migrations
{
    ...
    [Migration("20241222150829_AddRandomGraphCriteriaToAction")]
    partial class AddRandomGraphCriteriaToAction
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GraphAlgorithms.Repository.Entities.ActionEntity", b =>
                {
                    ...
                    b.Property<int?>("RandomGraphCriteriaID")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("RandomGraphCriteriaID");
            ...
            modelBuilder.Entity("GraphAlgorithms.Repository.Entities.RandomGraphCriteriaEntity", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("RandomGraphCriteria", (string)null);
            ...
            modelBuilder.Entity("GraphAlgorithms.Repository.Entities.UserEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "6d5b261d-f2c1-4d1a-9804-e782b98dad82",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "bd0e4238-e054-4585-ad84-dbef5d92a465",
            ...
            modelBuilder.Entity("GraphAlgorithms.Repository.Entities.ActionEntity", b =>
                {
                    ...
                    b.HasOne("GraphAlgorithms.Repository.Entities.RandomGraphCriteriaEntity", "RandomGraphCriteria")
                        .WithMany()
                        .HasForeignKey("RandomGraphCriteriaID")
                        .OnDelete(DeleteBehavior.Restrict);
                    ...
                    b.Navigation("RandomGraphCriteria");
                });
