...
namespace GraphAlgorithms.Repository.Migrations
{
    ...
    [Migration("20231216092158_AddedForGraphClassToActions")]
    partial class AddedForGraphClassToActions
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("GraphAlgorithms.Repository.Entities.ActionEntity", b =>
                {
                    ...
                    b.HasOne("GraphAlgorithms.Repository.Entities.GraphClassEntity", "GraphClass")
                        .WithMany()
                        .HasForeignKey("ForGraphClassID");

                    b.Navigation("ActionType");

                    b.Navigation("GraphClass");
                });
